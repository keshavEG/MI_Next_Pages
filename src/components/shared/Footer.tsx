          ...
          <div className="z-10 mt-0 w-full max-w-[1260px] max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
                <div className="marketinsideLogo flex flex-col text-base font-semibold leading-7 text-white uppercase max-md:mt-10">
                  <Image width={200} height={200} alt="marketinside-logo" src='/marketlogo.png' />
                  <div className="mt-7">
              ...
              <div className="flex flex-col ml-5 w-[21%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow p-2.5 mt-32 text-sm font-semibold leading-4 text-white max-md:mt-10">
                  ...
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">About Us</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Platform</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Data</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4 text-base">Plans</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4 max-md:mr-1.4">Research & Insights</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Privacy Policy</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4 max-md:mr-1.5">Terms & Conditions</a>
                </div>
              </div>
              <div className="flex flex-col ml-5 w-[22%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow p-2.5 mt-32 text-sm font-semibold leading-4 text-white max-md:mt-10">
                  ...
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-6">Importers</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-6">Exporters</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-6">Logistics</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-6">Corporation</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-6">Financial Institutions</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-6">IT and Consulting</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-6">Law Firms</a>
                </div>
              </div>
              <div className="flex flex-col ml-5 w-[24%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col p-2.5 mt-32 text-sm font-semibold leading-4 text-white max-md:mt-10">
                  ...
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Insurance</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Consulting and Research</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Sales and Marketing</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Asset Management Companies</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Academic Institutions</a>
                  <a style={{ textDecoration: 'none', color: 'white', cursor: 'pointer' }} className="mt-4">Government Agencies</a>
                </div>
              </div>
            </div>
          </div>
          <div className="flex gap-5 mt-10 max-w-full w-[591px] max-md:flex-wrap">
            ...
            <div className="flex flex-auto gap-3 justify-between items-start py-2.5 pl-2.5">
              <img
                loading="lazy"
