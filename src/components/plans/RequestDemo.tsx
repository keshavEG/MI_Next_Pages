  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button style={{ textTransform: 'uppercase', marginBottom: '10px', color:'#FB923C'}} className="mt-auto text-500 hover:text-600 transition-colors duration-300 text-sm font-semibold">
          Request a demo
        </button>
      </DialogTrigger>
