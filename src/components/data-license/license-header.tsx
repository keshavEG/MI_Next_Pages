        ...
        <div className="bg-gradient-to-br from-white to-gray-100 py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="flex flex-col lg:flex-row items-center justify-between">
                    <div className="desktop-view-license-img w-full lg:w-1/2 mb-10 lg:mb-0 flex justify-center">
                        <DotLottiePlayer
                    ...
                    <div className="w-full lg:w-1/2 lg:pl-12">
                        ...
                        <div className="mobile-view-license-img w-full lg:w-1/2 mb-10 lg:mb-0 flex justify-center">
                            <DotLottiePlayer
                                src="https://lottie.host/d91975e8-eafb-4584-aa71-89b991bcb875/YpFOtFaI58.json"
                                autoplay
                                loop
                        ...
                        <button style={{ width: '180px', height: '50px' }} className="bg-orange-500 text-white px-4 py-2 rounded-md text-lg hover:bg-orange-400 transition duration-300 shadow-md">
                            GET IN TOUCH
                        </button>
                    </div>
                </div>
